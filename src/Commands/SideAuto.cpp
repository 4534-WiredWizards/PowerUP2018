	...
	case 1:
		...
		if(Robot::location=="Left"){
			...
			if(Robot::SwitchPosition[0]=='L') {
				...
				AddSequential(new DriveStraightDistance(168,.5));
				AddSequential(new  LiftToHeight(10));
				AddSequential(new TurnAngle(90, .5));
				AddSequential(new DriveStraightDistance(26,.5));
				AddSequential(new  EjectBox(1));
			}
			else{
				//robot on left going to the right switch
				AddSequential(new DriveStraightDistance(70,.5));
				AddSequential(new  LiftToHeight(10));
				AddSequential(new TurnAngle(90, .5));
				AddSequential(new DriveStraightDistance(240,.5));
			...
			if(Robot::SwitchPosition[0]=='R') {
				...
				AddSequential(new LiftToHeight(10));
				AddSequential(new TurnAngle(-90, .5));
				AddSequential(new DriveStraightDistance(239.94,.5));
				AddSequential(new TurnAngle(0, .5));
				AddSequential(new DriveStraightDistance(84,.5));
				AddSequential(new EjectBox(1));
			}
	...
	case 2:
		...
		if (Robot::location=="Right"){
			...
			if (Robot::SwitchPosition[1]=='R'){
				...
				AddSequential(new DriveStraightDistance(260,.5));
				AddSequential(new LiftToHeight(40));
				AddSequential(new TurnAngle(-90, .5));
				AddSequential(new DriveStraightDistance(71,.5));
				AddSequential(new TurnAngle(0, .5));
				AddSequential(new DriveStraightDistance(6,.5));
				AddSequential(new EjectBox(1));
			}
			else{
				//robot is on the right going to the left scale
				AddSequential(new DriveStraightDistance(230,.5));
				AddSequential(new LiftToHeight(40));
				AddSequential(new TurnAngle(-90, .5));
				AddSequential(new DriveStraightDistance(192,.5));
				AddSequential(new TurnAngle(0, .5));
				AddSequential(new DriveStraightDistance(38,.5));
				AddSequential(new EjectBox(1));
			}
		}
		else{
			...
			if (Robot::SwitchPosition[1]=='L'){
				...
				AddSequential(new LiftToHeight(40));
				AddSequential(new TurnAngle(90, .5));
				AddSequential(new DriveStraightDistance(192.5,.5));
				AddSequential(new TurnAngle(0, .5));
				AddSequential(new DriveStraightDistance(37.65,.5));
				AddSequential(new EjectBox(1));
			}
		}
	...
	case 3:
		...
		if(Robot::SwitchPosition[0]=='L'){
			...
			if(Robot::location=="Left") {
				...
				AddSequential(new  LiftToHeight(10));
				AddSequential(new TurnAngle(90, .5));
				AddSequential(new DriveStraightDistance(26.06,.5));
				AddSequential(new  EjectBox(1));
				AddSequential(new DriveStraightDistance(-26.06,.5));
				AddSequential(new TurnAngle(0,.5));
				...
				AddSequential(new DriveStraightDistance(89,.5));
				AddSequential(new LiftToHeight(0));
			}
			//goes form the left switch to the scale
			if(Robot::SwitchPosition[1]=='L'){
				//going from the left switch to the left scale
				AddSequential(new DriveStraightDistance(82,.5));
				AddSequential(new TurnAngle(90,.5));
				AddSequential(new DriveStraightDistance(71,.5));
				//insert box grabbing code here
				AddSequential(new TurnAngle(0,.5));
				AddSequential(new DriveStraightDistance(50,.5));
				AddSequential(new EjectBox(1));
			}
			else{
				...
				AddSequential(new DriveStraightDistance(71,.5));
				//insert box grabbing code here
				AddSequential(new DriveStraightDistance(121,.5));
				AddSequential(new TurnAngle(0,.5));
				AddSequential(new DriveStraightDistance(50,.5));
				AddSequential(new EjectBox(1));
			}
