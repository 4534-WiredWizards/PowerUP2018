...
TurnAnglePID::TurnAnglePID(double angle, double rate, bool isAbsolute): frc::PIDCommand(0.01350, 0.0000, 0.0) {
    m_angle = angle;
    m_angle = fmod(m_angle + 360000000, 360);
    m_rate = rate;
//    SetTimeout(angle / 90); //it shouldn't
...
TurnAnglePID::TurnAnglePID(double angle, double rate) : frc::PIDCommand(0.0150, 0.00000000000, 0.0) {
    m_angle = angle;
    m_angle = fmod(m_angle + 360000000, 360);
    m_rate = rate;
    m_isAbsolute = true;
