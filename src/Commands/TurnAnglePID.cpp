...
TurnAnglePID::TurnAnglePID(double angle, double rate, bool isAbsolute): frc::PIDCommand(0.0170, 0.0000, 0.0) {
    m_angle = angle;
...
TurnAnglePID::TurnAnglePID(double angle, double rate) : frc::PIDCommand(0.0170, 0.00000, 0.0) {
    m_angle = angle;
    m_angle = fmod(m_angle + 360000000, 360);
    m_rate = rate;
    m_isAbsolute = true;
